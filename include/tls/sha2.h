...
public:
    ...
    static constexpr int output_size = 28; ///< Output size in bytes

    /**
     * @brief Constructs a SHA-224 object.
     */
    sha224();

    /**
     * @brief Computes the SHA-224 hash of the input data.
     ...
     * @return The SHA-224 hash as an array of bytes.
     */
    template<class It>
...
template<class It>
std::array<unsigned char, sha224::output_size> sha224::hash(It begin, It end) {
