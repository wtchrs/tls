...
protected:
    ...
    static const int ROUND = 11; ///< Number of rounds

    unsigned char schedule[ROUND][N * 4]; ///< Key schedule for encryption and decryption
...
private:
    ...
    static constexpr unsigned char rcon[10][4] = {
