...
class AES128 {
protected:
    static constexpr int N = 4; // Key size in words
    static constexpr int ROUND = 11; // Number of rounds

    unsigned char schedule_[ROUND][N * 4]; // Key schedule for encryption and decryption

private:
    // clang-format off

    /** Round constants for key expansion. */
    static constexpr unsigned char R_CON[10][4] = {
    ...
    /** Inverse S-box for inverse SubBytes step. */
...
private:
    ...
    /**
     * @brief Doubles the value of a byte in GF(2^8).
     * @param c The byte to double.
     * @return The doubled byte.
     */
    [[nodiscard]]
